...
<body>
    <h1>Mis Productos</h1>
    <a href="../producto/agregarProducto.php">Agregar Producto</a>
    <table>
        <tr>
            <th>ID</th>
            <th>Nombre</th>
        ...
        <?php if ($result->num_rows > 0): ?>
            ...
            <tr>
                ...
                <td>
                    <a href="../producto/editarProducto.php?id=<?php echo $producto['id_producto']; ?>">Editar</a>
                    <form method="post" action="../producto/eliminarProducto.php" style="display:inline;">
